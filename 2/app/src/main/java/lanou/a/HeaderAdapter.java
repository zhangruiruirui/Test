...
public class HeaderAdapter extends RecyclerView.Adapter {
    // 内部Adapter,就是我们之前写的没有头布局的Adapter
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (headViews.get(viewType) != null) {// 判断是否有头布局
            holder = new CommonViewHolder(headViews.get(viewType));
        } else {
    ...
    public int getItemCount() {
        // 总共的航布局个数是 头布局个数 + 里面Adapter数据的个数和
